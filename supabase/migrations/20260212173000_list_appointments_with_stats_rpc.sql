-- Dashboard appointment list RPC with unified member/comment count rules.
...
revoke all on function public.list_appointments_with_stats(uuid, uuid, text, text, timestamptz, integer) from public;
grant execute on function public.list_appointments_with_stats(uuid, uuid, text, text, timestamptz, integer) to authenticated;
