...
drop function if exists public.list_appointment_history_with_stats(
  uuid,
  integer,
  integer
);

create function public.list_appointment_history_with_stats(
  p_user_id uuid,
...
revoke all on function public.list_appointment_history_with_stats(
  uuid,
  integer,
  integer
) from public;

grant execute on function public.list_appointment_history_with_stats(
  uuid,
  integer,
  integer
) to authenticated;
