...
-- Remove PUBLIC execute on all application functions.
-- This prevents implicit execution by every role (including anon) via '=X'.
...
-- Keep explicit pre-auth execution only where intended.
